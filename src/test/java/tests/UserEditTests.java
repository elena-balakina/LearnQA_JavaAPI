...
public class UserEditTests extends BaseTestCase {
    ...
    public void editJustCreatedUserTest() {
        ...
        // get edited data
        Response responseChangedUser = RestAssured
                .given()
                .header("x-csrf-token", this.getHeader(responseGetAuth, "x-csrf-token"))
                .cookie("auth_sid", this.getCookie(responseGetAuth, "auth_sid"))
        ...
        System.out.println(responseChangedUser.asString());
        Assertions.assertJsonByName(responseChangedUser, "firstName", newFirstName);
    }
}
